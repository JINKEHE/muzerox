...
def qtransform_by_updatable_min_max(
    tree: tree_lib.Tree,
    node_index: chex.Numeric,
    min_value: chex.Numeric,
    max_value: chex.Numeric,
    *,
    epsilon: chex.Numeric = 0.01
) -> chex.Array:
  ...
  normalized_qvalues = (safe_qvalues - min_value) / jnp.maximum(max_value - min_value, epsilon)
  return normalized_qvalues
